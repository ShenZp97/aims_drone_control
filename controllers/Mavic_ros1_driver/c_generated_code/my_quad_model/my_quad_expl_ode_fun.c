...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w14;
  ...
  /* #104: @3 = (@3+@15) */
  w3 += w15;
  /* #105: @17 = vertcat(@1, @5, @3) */
  rr=w17;
  *rr++ = w1;
  *rr++ = w5;
  *rr++ = w3;
  /* #106: @1 = 0.5069 */
  w1 = 5.0690000000000002e-01;
  /* #107: @17 = (@17/@1) */
  for (i=0, rr=w17; i<3; ++i) (*rr++) /= w1;
  /* #108: @13 = mac(@21,@17,@13) */
  ...
  *rr++ = w15;
  /* #114: @2 = @7' */
  casadi_copy(w7, 4, w2);
  /* #115: @8 = [-0.151294, 0.151294, -0.127453, 0.127453] */
  ...
  /* #127: @2 = @7' */
  casadi_copy(w7, 4, w2);
  /* #128: @8 = [-0.114854, -0.114854, 0.117179, 0.117179] */
...
CASADI_SYMBOL_EXPORT int my_quad_expl_ode_fun_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 7*sizeof(const casadi_real*);
  if (sz_res) *sz_res = 2*sizeof(casadi_real*);
  if (sz_iw) *sz_iw = 0*sizeof(casadi_int);
  if (sz_w) *sz_w = 97*sizeof(casadi_real);
  return 0;
}
